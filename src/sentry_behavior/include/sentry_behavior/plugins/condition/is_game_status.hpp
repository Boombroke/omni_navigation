...
#ifndef SENTRY_BEHAVIOR__PLUGINS__CONDITION__IS_GAME_STATUS_HPP_
#define SENTRY_BEHAVIOR__PLUGINS__CONDITION__IS_GAME_STATUS_HPP_
...
#endif  // SENTRY_BEHAVIOR__PLUGINS__CONDITION__IS_GAME_STATUS_HPP_
