...
#ifndef SENTRY_BEHAVIOR__PLUGINS__CONDITION__IS_ATTACKED_HPP_
#define SENTRY_BEHAVIOR__PLUGINS__CONDITION__IS_ATTACKED_HPP_
...
#endif  // SENTRY_BEHAVIOR__PLUGINS__CONDITION__IS_ATTACKED_HPP_
