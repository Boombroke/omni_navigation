...
#ifndef SENTRY_BEHAVIOR__PLUGINS__CONDITION__IS_RFID_DETECTED_HPP_
#define SENTRY_BEHAVIOR__PLUGINS__CONDITION__IS_RFID_DETECTED_HPP_
...
#endif  // SENTRY_BEHAVIOR__PLUGINS__CONDITION__IS_RFID_DETECTED_HPP_
