...
#ifndef SENTRY_BEHAVIOR__SENTRY_BEHAVIOR_SERVER_HPP_
#define SENTRY_BEHAVIOR__SENTRY_BEHAVIOR_SERVER_HPP_
...
#endif  // SENTRY_BEHAVIOR__SENTRY_BEHAVIOR_SERVER_HPP_
